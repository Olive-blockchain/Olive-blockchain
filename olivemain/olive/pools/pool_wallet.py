...
from olive.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from olive.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from olive.protocols.pool_protocol import POOL_PROTOCOL_VERSION
...
from olive.pools.pool_puzzles import (
...
from olive.util.ints import uint8, uint32, uint64
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `olive singleton` that is
