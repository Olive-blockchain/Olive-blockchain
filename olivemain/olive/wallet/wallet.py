...
from olive.consensus.cost_calculator import calculate_cost_of_program, NPCResult
...
from olive.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from olive.wallet.puzzles.puzzle_utils import (
...
from olive.wallet.secret_key_store import SecretKeyStore
from olive.wallet.sign_coin_solutions import sign_coin_solutions
...
class Wallet:
    ...
    async def create_spend_bundle_relative_olive(self, olive_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if olive_amount < 0:
            utxos = await self.select_coins(abs(olive_amount), exclude)
        else:
        ...
        olive_amount = spend_value + olive_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": olive_amount}]
