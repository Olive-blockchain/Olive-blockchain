...
from olive.pools.pool_config import PoolWalletConfig
from olive.util.config import load_config, save_config, create_default_olive_config
...
def test_pool_config():
    ...
    create_default_olive_config(test_root, ["config.yaml"])
    ...
    d = {
        ...
        "target_puzzle_hash": "344587cf06a39db471d2cc027504e8688a0a67cce961253501c956c73603fd58",
    }
