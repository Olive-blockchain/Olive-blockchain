...
If you want to learn more about this project, read the [wiki](https://github.com/olive-Network/olive-blockchain/wiki), or check out the [green paper](https://www.oliveblockchain.co/assets/olivePaper.pdf).
