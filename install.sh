...
python -m pip install --extra-index-url https://pypi.olive.net/simple/ miniupnpc==2.2.2
python -m pip install -e . --extra-index-url https://pypi.olive.net/simple/
...
echo ""
echo "Type '. ./activate' and then 'olive init' to begin."
