...
If you want to learn more about this project, read the [wiki](https://github.com/pinksheetscrypto/olive-blockchain/wiki), or check out the [green paper](https://www.olive.net/assets/CovidGreenPaper.pdf).
