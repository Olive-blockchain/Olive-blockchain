...
import { CardStep, ConfirmDialog, Link, Select, StateColor } from '@olive/core';
    ...
    >
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/Olive-Network/olive-blockchain/wiki/k-sizes">Learn more</Link>
        </Trans>
      </Typography>
