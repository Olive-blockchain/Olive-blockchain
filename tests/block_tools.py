...
from olive.full_node.generator import setup_generator_args
from olive.full_node.mempool_check_conditions import GENERATOR_MOD
from olive.plotting.create_plots import create_plots
from olive.consensus.block_creation import unfinished_block_to_full_block
...
from olive.consensus.blockchain_interface import BlockchainInterface
from olive.consensus.coinbase import create_puzzlehash_for_pk, create_farmer_coin, create_pool_coin
from olive.consensus.constants import ConsensusConstants
from olive.consensus.default_constants import DEFAULT_CONSTANTS
from olive.consensus.deficit import calculate_deficit
from olive.consensus.full_block_to_block_record import block_to_block_record
from olive.consensus.make_sub_epoch_summary import next_sub_epoch_summary
from olive.consensus.cost_calculator import NPCResult, calculate_cost_of_program
from olive.consensus.pot_iterations import (
    calculate_ip_iters,
...
from olive.consensus.vdf_info_computation import get_signage_point_vdf_info
from olive.full_node.signage_point import SignagePoint
from olive.plotting.plot_tools import PlotInfo, load_plots, parse_plot_info
...
from olive.types.blockchain_format.foliage import Foliage, FoliageBlockData, FoliageTransactionBlock, TransactionsInfo
...
from olive.types.blockchain_format.reward_chain_block import RewardChainBlockUnfinished
from olive.types.blockchain_format.sized_bytes import bytes32
from olive.types.blockchain_format.slots import (
...
from olive.types.blockchain_format.vdf import VDFInfo, VDFProof
from olive.types.condition_with_args import ConditionWithArgs
from olive.types.end_of_slot_bundle import EndOfSubSlotBundle
from olive.types.full_block import FullBlock
from olive.types.generator_types import BlockGenerator, CompressorArg
...
from olive.util.block_cache import BlockCache
...
class BlockTools:
    ...
    def __init__(
        ...
        if len(self.pool_pubkeys) == 0 or len(self.farmer_pubkeys) == 0:
            raise RuntimeError("Keys not generated. Run `olive generate keys`")
    ...
    def init_plots(self, root_path: Path):
        ...
        try:
            ...
            args.pool_contract_address = encode_puzzle_hash(self.pool_ph, "xol")
...
def get_plot_dir() -> Path:
    cache_path = Path(os.path.expanduser(os.getenv("CHIA_ROOT", "~/.olive/"))) / "test-plots"
    mkdir(cache_path)
    return cache_path
