...
from olive.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "olive" in cc_discrepancies:
                    cc_discrepancies["olive"] = cc_discrepancies["olive"] + diff
                else:
                    cc_discrepancies["olive"] = diff
