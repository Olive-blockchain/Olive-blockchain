...
def show_plots(root_path: Path):
    from olive.plotting.plot_tools import get_plot_directories

    print("Directories where plots are being searched for:")
    print("Note that subdirectories must be added manually")
    print(
        "Add with 'olive plots add -d [dir]' and remove with"
        + " 'olive plots remove -d [dir]'"
        + " Scan and check plots with 'olive plots check'"
    )
    print()
...
def check_cmd(
    ...
    from olive.plotting.check_plots import check_plots
...
def add_cmd(ctx: click.Context, final_dir: str):
    from olive.plotting.plot_tools import add_plot_directory
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from olive.plotting.plot_tools import remove_plot_directory
