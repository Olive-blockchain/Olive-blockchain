...
from olive.util.network import is_localhost, is_in_network
...
class OliveServer:
    def __init__(
        ...
        olive_ca_crt_key: Tuple[Path, Path],
        name: str = None,
        ...
        self.olive_ca_crt_path, self.olive_ca_key_path = olive_ca_crt_key
