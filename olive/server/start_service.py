...
from olive.util.config import load_config, load_config_cli
...
class Service:
    def __init__(
        ...
        proctitle_name = f"olive_{service_name}"
        ...
        olive_ca_crt, olive_ca_key = olive_ssl_ca_paths(root_path, self.config)
