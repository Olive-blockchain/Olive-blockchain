...
from olive.cmds.init_funcs import check_keys, olive_init
from olive.cmds.passphrase_funcs import default_passphrase, using_default_passphrase
from olive.daemon.keychain_server import KeychainServer, keychain_commands
from olive.daemon.windows_signal import kill
from olive.server.server import ssl_context_for_root, ssl_context_for_server
...
from olive.util.json_util import dict_to_json_str
from olive.util.keychain import (
    Keychain,
...
from olive.util.service_groups import validate_service
from olive.util.setproctitle import setproctitle
from olive.util.ws_message import WsRpcMessage, create_payload, format_response
...
service_plotter = "olive plots create"
...
if getattr(sys, "frozen", False):
    name_map = {
        "olive": "olive",
        "olive_wallet": "start_wallet",
        "olive_full_node": "start_full_node",
        "olive_harvester": "start_harvester",
        "olive_farmer": "start_farmer",
        "olive_introducer": "start_introducer",
        "olive_timelord": "start_timelord",
        "olive_timelord_launcher": "timelord_launcher",
        "olive_full_node_simulator": "start_simulator",
    }
...
class WebSocketServer:
    ...
    async def exit(self) -> Dict[str, Any]:
        ...
        log.info("olive daemon exiting in 5 seconds")
