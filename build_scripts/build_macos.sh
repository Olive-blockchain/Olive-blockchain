...
echo "Chia Installer Version is: $OLIVE_INSTALLER_VERSION"
...
--icon=src/assets/img/Chia.icns --overwrite --app-bundle-id=net.olive.blockchain \
...
DMG_NAME="Chia-$OLIVE_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Chia-darwin-x64/Chia.app Chia-$OLIVE_INSTALLER_VERSION \
...
if [ "$NOTARIZE" ]; then
  ...
  notarize-cli --file=$DMG_NAME --bundle-id net.olive.blockchain \
...
# xcrun altool --notarize-app -f Chia-0.1.X.dmg --primary-bundle-id net.olive.blockchain -u username -p password
