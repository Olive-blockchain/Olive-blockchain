...
DMG_NAME="Kale-$OLIVE_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Kale-darwin-x64/Kale.app Kale-$OLIVE_INSTALLER_VERSION \
...
# xcrun altool --notarize-app -f Kale-0.1.X.dmg --primary-bundle-id net.olive.blockchain -u username -p password
