...
This repo includes the code for the Kale full node, farmer, and timelord (in olive folder), which are all written in python.
...
If you want to learn more about this project, read the [wiki](https://github.com/Kale-Network/olive-blockchain/wiki), or check out the [green paper](https://www.oliveblockchain.co/assets/KaleGreenPaper.pdf).
...
6. Install these linters https://github.com/Kale-Network/olive-blockchain/tree/main/.github/linters
