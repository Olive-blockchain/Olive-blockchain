...
## 1.1.6 Olive Blockchain 2021-05-20
...
## 1.1.5 Olive Blockchain 2021-05-09
...
## 1.1.4 Olive Blockchain 2021-05-04
...
## 1.1.3 Olive Blockchain 2021-05-01
...
## 1.1.2 Olive Blockchain 2021-04-24
...
## 1.1.1 Olive Blockchain 2021-04-21
...
## 1.1.0 Olive Blockchain 2021-04-21

### Added

- This fork release includes full transaction support for the Olive Blockchain. Transactions are still disabled until 5/3/2021 at 10:00AM PDT. It is hard to overstate how much work and clean up went into this release.
...
## 1.0.5 Olive Blockchain 2021-04-14
...
## 1.0.3 Olive Blockchain 2021-03-30

### Added

- This is a minor bug fix release for version 1.0.2
- You should review the [release notes for v1.0.2](https://github.com/pinksheetscrypto/olive-blockchain/releases/tag/1.0.2) but we especially want to point out that wallet sync is much faster than in 1.0.1 and earlier versions.
...
## 1.0.2 Olive Blockchain 2021-03-30
...
## 1.0.1 Olive Blockchain 2021-03-23
...
- This is a hard fork/breaking change from RC6/7. TCOV Coins will **not** be moved forward but your plots and keys and parts of your configuration do. When you install this version before 10AM PDST on 3/16/2021 it will load up, start finding peers, and otherwise wait for the flag drop at that time to start farming. This is likely to be the last dress rehearsal for mainnet launch. Our [3/15/2021 blog post](https://www.oliveblockchain.co/2021/03/15/mainnet-update.html) has more details on the current mainnet launch plan.
...
- `olive farm summary` will now display TCOV or COV as appropriate.
...
- Some users can't plot in the GUI in MacOS Big Sur - especially on M1. See issue [1189](https://github.com/pinksheetscrypto/olive-blockchain/issues/1189)
...
- We have moved to a new and much higher scalability download.oliveblockchain.co to support the mainnet launch flag and additional download demand.
- To always get the latest testnet and then mainnet installers you can now use a latest URL: [Windows](https://download.oliveblockchain.co/latest/Setup-Win64.exe) and [MacOS x86_64](https://download.oliveblockchain.co/latest/Setup-MacOS.dmg).
- Olive wheels not on Pypi and some dependecies not found there also are now on pypi.chia.net.
...
- We now support a "green flag" chain launch process. A new version of the software will poll download.oliveblockchain.co/notify/ for a signed json file that will be the genesis block of the chain for that version. This will allow unattended start at mainnet.
...
- Python root CA certificates have issues so we have added the Mozilla certificate store via curl.se and use that to connect to backup.oliveblockchain.co via https, for example.
...
- However, we have updated and test compiled all Olive dependencies on Apple Silicon and will be making available a test .dmg for MacOS ARM64 shortly.
...
- The entire CLI has been ported to [Click](https://click.palletsprojects.com/en/7.x/). Huge thanks to @jespino for the big assist and @unparalleled-js for the [recommendation and the initial start](https://github.com/pinksheetscrypto/olive-blockchain/issues/464). This will make building out the CLI much easier. There are some subtle changes and some shortcuts are not there anymore. `olive -h` and `olive SUBCOMMAND -h` can be your guide.
...
- This is an errata release for Release Candidate 1. There were a couple of things that did not smoothly migrate from the Beta versions. Please make sure you also consult the [release notes for RC-1](https://github.com/pinksheetscrypto/olive-blockchain/releases/tag/1.0rc1) was well.
...
- Installers will now be of the pattern OliveSetup-0.2.1.exe. `0.2` is release candidate and the final `.1` is the first release candidate.
...
- We have integrated with crowdin to make it easier to translate the GUI. Check out [Olive Blockchain GUI](https://crowdin.com/project/olive-blockchain) there.
- We have added Italian, Russian, and Finnish. More to come soon.
- There is now remote UI support. [Documents](https://github.com/pinksheetscrypto/olive-blockchain-gui/blob/main/remote.md) will temporarily live in the repository but have moved to the [wiki](https://github.com/pinksheetscrypto/olive-blockchain/wiki/Connecting-the-UI-to-a-remote-daemon). Thanks to @dkackman for this excellent addition!
...
- 'olive wallet send' now takes in TCOV or COV as units instead of mojos.
...
- The GUI is now in a separate submodule repository from olive-blockchain, [olive-blockchain-gui](https://github.com/pinksheetscrypto/olive-blockchain-gui). The installers and install scripts have been updated and it continues to follow the same install steps. Note that the GUI directory will now be `olive-blockchain-gui`. The workflow for this may be "touch and go" for people who use the git install methods over the short term.
...
- The cli wallet, `olive wallet`, was incorrectly displaying TCOV balances as if they were Coloured Coins.
...
- We have made the "Help Translate" button in the GUI open in your default web browser and added instructions for adding new translations and more phrases in existing translations at that [URL](https://github.com/pinksheetscrypto/olive-blockchain/tree/main/electron-react/src/locales). Try the "Help Translate" option on the language selection pull down to the left of the dark/light mode selection at the top right of the GUI.
...
- We are down to only one sub dependency that does not ship binary wheels for all four platforms. The only platform still impacted is ARM64 (generally Raspberry Pi) but that only means that you still need the minor build tools as outlined on the [wiki](https://github.com/pinksheetscrypto/olive-blockchain/wiki/Raspberry-Pi).
...
- Last Attempted Proof is now fixed. This will show you the last time one of your plots passed the [plot filter](https://github.com/pinksheetscrypto/olive-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it).
...
- There is a lot more information and explanation of the new consensus algorithm in the New Consensus Working Document linked from [oliveblockchain.co](https://oliveblockchain.co/). Among the improvements this gives the Olive blockchain are a much higher security level against all attacks, more frequent transaction blocks that have less time variation between them and are then buried under confirmations (sub blocks also count towards re-org security) much more quickly.
...
- Changes were made to chiapos to correctly support the new bitfiled backpropogation on FreeBSD and OpenBSD. With the exception of needing to work around python cryptography as outlined on the wiki, FreeBSD and OpenBSD should be able to compile and run olive-blockchain.
...
- A segfault caused by memory leaks in bls-library has been fixed. This should end the random farmer and harvester crashes over time as outlined in [Issue 500](https://github.com/pinksheetscrypto/olive-blockchain/issues/500).
...
- In the GUI there was [a regression](https://github.com/pinksheetscrypto/olive-blockchain/issues/484) that removed the scroll bar on the Plot page. The scroll bar has returned!
...
- Logging had [a regression](https://github.com/pinksheetscrypto/olive-blockchain/issues/485) where log level could no longer be set by service.
...
- The GUI now supports translations and localizations. If you'd like to add your language you can see the examples in [the locales directory](https://github.com/pinksheetscrypto/olive-blockchain/tree/dev/electron-react/src/locales) of the olive-blockchain repository.
...
- You can now backup your wallet related metadata in an encrypted and signed file to a free service from Olive Network at backup.oliveblockchain.co. Simply having a backup of your private key will allow you to fully restore the state of your wallet including coloured coins, rate limited wallets, distributed identity wallets and many more. Your private key is used to automatically restore the last backup you saved to the Olive backup cloud service. This service is open source and ultimately you will be able to configure your backups to go to backup.oliveblockchain.co, your own installation, or a third party's version of it.
...
- `olive init` now automatically disxolers previous releases in each new release.
...
- The Windows installer is now signed by a Olive Network certificate. It may take some time to develop enough reputation to not warn multiple times during install.
...
- We now codesign the Apple .dmg installer with the Olive Network developer ID on both GitHub Actions and Azure Pipelines. We will be notarizing and distributing the Azure Pipelines version as it's built on MacOS Mojave (10.14.6) for stronger cross version support.
...
- The user interface now refers to olive coins with their correct currency code of COV.
...
- There was a regression in Olive Proof of Space ([chiapos](https://github.com/pinksheetscrypto/chiapos)) that came from our efforts to speed up plotting on Windows native. Now k>=32 plots work correctly. We made additional bug fixes and corrected limiting small k size generation.
...
- Most of the content of README.md and INSTALL.md have been moved to the [repository wiki](https://github.com/pinksheetscrypto/olive-blockchain/wiki) and placed in [INSTALL](https://github.com/pinksheetscrypto/olive-blockchain/wiki/INSTALL) and [Quick Start Guide](https://github.com/pinksheetscrypto/olive-blockchain/wiki/Quick-Start-Guide)
...
- We suggest you take a look at our [Upgrading documentation](https://github.com/pinksheetscrypto/olive-blockchain/wiki/Updating-beta-software) if you aren't performing a new install.
...
- Plots of k>=32 are not working for farming, and some broken plots can cause a memory leak. A [workaround is available](https://github.com/pinksheetscrypto/olive-blockchain/wiki/Beta-1.4-k=32-or-larger-work-around).
...
- There is a new command `olive init` that will migrate files and generate your initial configuration. If you want to use the Wallet or farm, you will also have to `olive-generate-keys`. You can read step by step instructions for [upgrading from a previous beta release](https://github.com/pinksheetscrypto/olive-blockchain/wiki/Updating-beta-software). If you've set `$OLIVE_ROOT` you will have to make sure your existing configuration remains compatible manually.
...
- There is now full transaction support on the Olive blockchain. In this initial Beta 1.0 release, all transaction types are supported though the wallets and UIs currently only directly support basic transactions like coinbase rewards and sending coins while paying fees. UI support for our [smart transactions](https://github.com/pinksheetscrypto/wallets/blob/main/README.md) will be available in the UIs shortly.
...
- We have revamped the olive management command line. To start a farmer all you have to do is start the venv with `. ./activate` and then type `olive-start-farmer &`. The [README.md](https://github.com/pinksheetscrypto/olive-blockchain/blob/main/README.md) has been updated to reflect the new commands.
...
- More details on the release at [https://www.oliveblockchain.co/developer/](https://www.oliveblockchain.co/developer/)

[unreleased]: https://github.com/pinksheetscrypto/olive-blockchain/compare/1.0beta5...dev
[1.0beta5]: https://github.com/pinksheetscrypto/olive-blockchain/compare/1.0beta4...1.0beta5
[1.0beta4]: https://github.com/pinksheetscrypto/olive-blockchain/compare/1.0beta3...1.0beta4
[1.0beta3]: https://github.com/pinksheetscrypto/olive-blockchain/compare/1.0beta2...1.0beta3
[1.0beta2]: https://github.com/pinksheetscrypto/olive-blockchain/compare/1.0beta1...1.0beta2
[1.0beta1]: https://github.com/pinksheetscrypto/olive-blockchain/compare/alpha-1.5.1...1.0beta1
[alpha 1.5.1]: https://github.com/pinksheetscrypto/olive-blockchain/compare/alpha-1.5...alpha-1.5.1
[alpha 1.5]: https://github.com/pinksheetscrypto/olive-blockchain/compare/alpha-1.4.1...alpha-1.5
[alpha 1.4.1]: https://github.com/pinksheetscrypto/olive-blockchain/compare/alpha-1.4...alpha-1.4.1
[alpha 1.4]: https://github.com/pinksheetscrypto/olive-blockchain/compare/alpha-1.3...alpha-1.4
[alpha 1.3]: https://github.com/pinksheetscrypto/olive-blockchain/compare/alpha-1.2...alpha-1.3
[alpha 1.2]: https://github.com/pinksheetscrypto/olive-blockchain/compare/alpha-1.1.1...alpha-1.2
[alpha 1.1.1]: https://github.com/pinksheetscrypto/olive-blockchain/compare/alpha-1.1...alpha-1.1.1
[alpha 1.1]: https://github.com/pinksheetscrypto/olive-blockchain/compare/alpha-1.0...alpha-1.1
[alpha 1.0]: https://github.com/pinksheetscrypto/olive-blockchain/releases/tag/Alpha-1.0
