...
- This is the 1.0 release of Kalelisp. Much has been massaged and finalized. We will be putting a focus on updating and expanding the documentation on [olivelisp.com](https://olivelisp.com) shortly.
...
- You should review the [release notes for v1.0.2](https://github.com/Kale-Network/olive-blockchain/releases/tag/1.0.2) but we especially want to point out that wallet sync is much faster than in 1.0.1 and earlier versions.
...
- This is a hard fork/breaking change from RC6/7. TXCH Coins will **not** be moved forward but your plots and keys and parts of your configuration do. When you install this version before 10AM PDST on 3/16/2021 it will load up, start finding peers, and otherwise wait for the flag drop at that time to start farming. This is likely to be the last dress rehearsal for mainnet launch. Our [3/15/2021 blog post](https://www.oliveblockchain.co/2021/03/15/mainnet-update.html) has more details on the current mainnet launch plan.
...
- Some users can't plot in the GUI in MacOS Big Sur - especially on M1. See issue [1189](https://github.com/Kale-Network/olive-blockchain/issues/1189)
...
- We now hand build Apple Silicon native binary wheels for all olive-blockchain dependencies and host them at [https://pypi.oliveblockchain.co/simple](https://pypi.oliveblockchain.co/simple). We are likely to hand build a MacOS ARM64 dmg available and certainly will for 1.0. You can install natively on M1 now with the `git clone` developer method today. Just make sure Python 3.9 is installed. `python3 --version` works.
...
- Generators have been re-worked in CLVM. We added a olivelisp deserialization puzzle and improved the low-level generator. We reduce the accepted atom size to 1MB during KaleLisp native deserialization.
...
- Kale wheels not on Pypi and some dependecies not found there also are now on pypi.oliveblockchain.co.
...
- The entire CLI has been ported to [Click](https://click.palletsprojects.com/en/7.x/). Huge thanks to @jespino for the big assist and @unparalleled-js for the [recommendation and the initial start](https://github.com/Kale-Network/olive-blockchain/issues/464). This will make building out the CLI much easier. There are some subtle changes and some shortcuts are not there anymore. `olive -h` and `olive SUBCOMMAND -h` can be your guide.
...
- This is an errata release for Release Candidate 1. There were a couple of things that did not smoothly migrate from the Beta versions. Please make sure you also consult the [release notes for RC-1](https://github.com/Kale-Network/olive-blockchain/releases/tag/1.0rc1) was well.
...
- We have integrated with crowdin to make it easier to translate the GUI. Check out [Kale Blockchain GUI](https://crowdin.com/project/olive-blockchain) there.
- We have added Italian, Russian, and Finnish. More to come soon.
- There is now remote UI support. [Documents](https://github.com/Kale-Network/olive-blockchain-gui/blob/main/remote.md) will temporarily live in the repository but have moved to the [wiki](https://github.com/Kale-Network/olive-blockchain/wiki/Connecting-the-UI-to-a-remote-daemon). Thanks to @dkackman for this excellent addition!
...
- The GUI is now in a separate submodule repository from olive-blockchain, [olive-blockchain-gui](https://github.com/Kale-Network/olive-blockchain-gui). The installers and install scripts have been updated and it continues to follow the same install steps. Note that the GUI directory will now be `olive-blockchain-gui`. The workflow for this may be "touch and go" for people who use the git install methods over the short term.
...
- We have made the "Help Translate" button in the GUI open in your default web browser and added instructions for adding new translations and more phrases in existing translations at that [URL](https://github.com/Kale-Network/olive-blockchain/tree/main/electron-react/src/locales). Try the "Help Translate" option on the language selection pull down to the left of the dark/light mode selection at the top right of the GUI.
...
- We are down to only one sub dependency that does not ship binary wheels for all four platforms. The only platform still impacted is ARM64 (generally Raspberry Pi) but that only means that you still need the minor build tools as outlined on the [wiki](https://github.com/Kale-Network/olive-blockchain/wiki/Raspberry-Pi).
...
- Last Attempted Proof is now fixed. This will show you the last time one of your plots passed the [plot filter](https://github.com/Kale-Network/olive-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it).
...
- A segfault caused by memory leaks in bls-library has been fixed. This should end the random farmer and harvester crashes over time as outlined in [Issue 500](https://github.com/Kale-Network/olive-blockchain/issues/500).
...
- In the GUI there was [a regression](https://github.com/Kale-Network/olive-blockchain/issues/484) that removed the scroll bar on the Plot page. The scroll bar has returned!
...
- Logging had [a regression](https://github.com/Kale-Network/olive-blockchain/issues/485) where log level could no longer be set by service.
...
- The GUI now supports translations and localizations. If you'd like to add your language you can see the examples in [the locales directory](https://github.com/Kale-Network/olive-blockchain/tree/dev/electron-react/src/locales) of the olive-blockchain repository.
...
- You can now backup your wallet related metadata in an encrypted and signed file to a free service from Kale Network at backup.oliveblockchain.co. Simply having a backup of your private key will allow you to fully restore the state of your wallet including coloured coins, rate limited wallets, distributed identity wallets and many more. Your private key is used to automatically restore the last backup you saved to the Kale backup cloud service. This service is open source and ultimately you will be able to configure your backups to go to backup.oliveblockchain.co, your own installation, or a third party's version of it.
...
- Most of the content of README.md and INSTALL.md have been moved to the [repository wiki](https://github.com/Kale-Network/olive-blockchain/wiki) and placed in [INSTALL](https://github.com/Kale-Network/olive-blockchain/wiki/INSTALL) and [Quick Start Guide](https://github.com/Kale-Network/olive-blockchain/wiki/Quick-Start-Guide)
...
- Kale start commands like `olive start farmer` and `olive stop node` now keep track of process IDs in a run/ directory in your configuration directory. `olive stop` is unlikely to work on Windows native for now. If `olive start -r node` doesn't work you can force the run/ directory to be reset with `olive start -f node`.
- We suggest you take a look at our [Upgrading documentation](https://github.com/Kale-Network/olive-blockchain/wiki/Updating-beta-software) if you aren't performing a new install.
...
- Plots of k>=32 are not working for farming, and some broken plots can cause a memory leak. A [workaround is available](https://github.com/Kale-Network/olive-blockchain/wiki/Beta-1.4-k=32-or-larger-work-around).
...
- There is a new command `olive init` that will migrate files and generate your initial configuration. If you want to use the Wallet or farm, you will also have to `olive-generate-keys`. You can read step by step instructions for [upgrading from a previous beta release](https://github.com/Kale-Network/olive-blockchain/wiki/Updating-beta-software). If you've set `$OLIVE_ROOT` you will have to make sure your existing configuration remains compatible manually.
...
- We have revamped the olive management command line. To start a farmer all you have to do is start the venv with `. ./activate` and then type `olive-start-farmer &`. The [README.md](https://github.com/Kale-Network/olive-blockchain/blob/main/README.md) has been updated to reflect the new commands.
...
- Kale fullnode, farmer and harvester now default to logging to olive.log in the olive-blockchain directory. This is configured in config.yaml and due to config.yaml changes it is recommended to edit the new template config instead of using older config.yaml’s from previous versions.
...
[unreleased]: https://github.com/Kale-Network/olive-blockchain/compare/1.0beta5...dev
[1.0beta5]: https://github.com/Kale-Network/olive-blockchain/compare/1.0beta4...1.0beta5
[1.0beta4]: https://github.com/Kale-Network/olive-blockchain/compare/1.0beta3...1.0beta4
[1.0beta3]: https://github.com/Kale-Network/olive-blockchain/compare/1.0beta2...1.0beta3
[1.0beta2]: https://github.com/Kale-Network/olive-blockchain/compare/1.0beta1...1.0beta2
[1.0beta1]: https://github.com/Kale-Network/olive-blockchain/compare/alpha-1.5.1...1.0beta1
[alpha 1.5.1]: https://github.com/Kale-Network/olive-blockchain/compare/alpha-1.5...alpha-1.5.1
[alpha 1.5]: https://github.com/Kale-Network/olive-blockchain/compare/alpha-1.4.1...alpha-1.5
[alpha 1.4.1]: https://github.com/Kale-Network/olive-blockchain/compare/alpha-1.4...alpha-1.4.1
[alpha 1.4]: https://github.com/Kale-Network/olive-blockchain/compare/alpha-1.3...alpha-1.4
[alpha 1.3]: https://github.com/Kale-Network/olive-blockchain/compare/alpha-1.2...alpha-1.3
[alpha 1.2]: https://github.com/Kale-Network/olive-blockchain/compare/alpha-1.1.1...alpha-1.2
[alpha 1.1.1]: https://github.com/Kale-Network/olive-blockchain/compare/alpha-1.1...alpha-1.1.1
[alpha 1.1]: https://github.com/Kale-Network/olive-blockchain/compare/alpha-1.0...alpha-1.1
[alpha 1.0]: https://github.com/Kale-Network/olive-blockchain/releases/tag/Alpha-1.0
