...
required to run a [Timelord](https://github.com/Kale-Network/olive-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Kale-Network/olive-blockchain/blob/main/install-timelord.sh)
