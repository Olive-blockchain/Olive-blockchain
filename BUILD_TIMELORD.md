...
required to run a [Timelord](https://github.com/pinksheetscrypto/olive-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/pinksheetscrypto/olive-blockchain/blob/main/install-timelord.sh)
